...
var prefixEnableCmd = &cobra.Command{
	...
	RunE:  runPrefixEnable,
}

func runPrefixEnable(cmd *cobra.Command, args []string) error {
...
var prefixDisableCmd = &cobra.Command{
	...
	RunE:  runPrefixDisable,
}

func runPrefixDisable(cmd *cobra.Command, args []string) error {
...
func runPrefixSet(cmd *cobra.Command, args []string) error {
	prefix := args[0]
...
Also shows the configured prefix from .versionator.yaml that will be used on 'prefix enable'.`,
	RunE: runPrefixStatus,
}

func runPrefixStatus(cmd *cobra.Command, args []string) error {
