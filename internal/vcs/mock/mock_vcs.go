...
func (m *MockVersionControlSystem) GetBranchCommit(branchName string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBranchCommit", branchName)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockVersionControlSystemMockRecorder) GetBranchCommit(branchName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBranchCommit", reflect.TypeOf((*MockVersionControlSystem)(nil).GetBranchCommit), branchName)
}
...
func (m *MockVersionControlSystem) GetTagCommit(tagName string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTagCommit", tagName)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockVersionControlSystemMockRecorder) GetTagCommit(tagName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTagCommit", reflect.TypeOf((*MockVersionControlSystem)(nil).GetTagCommit), tagName)
}
